...
from hyperagent.continuum import enable_continuum_from_env
...
def Setup(
    ...
    continuum_job_id: Optional[str] = None,
    continuum_metrics_path: Optional[str] = None,
):
    enable_continuum_from_env(
        default_job_id=continuum_job_id,
        metrics_path=continuum_metrics_path,
    )
...
class HyperAgent:
    def __init__(
        ...
        self.system, self.user_proxy, repo_dir = Setup(
            ...
            continuum_job_id=continuum_job_id,
